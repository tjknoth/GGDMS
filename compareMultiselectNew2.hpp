...
#include "multiselectTimingFunctionsNew2.cu"

#define NUMBEROFALGORITHMS 3
char* namesOfMultiselectTimingFunctions[NUMBEROFALGORITHMS] = 
  {"Sort and Choose Multiselect", "Bucket Multiselect", "Bucket MultiselectNew2"}; //, "Original Bucket Multiselect"};

namespace CompareMultiselectNew2 {
